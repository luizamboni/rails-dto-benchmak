...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<polyfill>.freeze, ["~> 1.8".freeze])
  s.add_runtime_dependency(%q<safe_type>.freeze, ["~> 1.1".freeze, ">= 1.1.1".freeze])
  s.add_runtime_dependency(%q<sorbet-runtime>.freeze, [">= 0.4.4704".freeze])
  s.add_development_dependency(%q<sorbet>.freeze, [">= 0.4.4704".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.8".freeze, ">= 3.8".freeze])
  s.add_development_dependency(%q<byebug>.freeze, ["~> 11.0.1".freeze, ">= 11.0.1".freeze])
end
